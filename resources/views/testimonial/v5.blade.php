...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/testimonial/testimonialv5/testimonialv5.css') }}">
...
<body>
    ...
    <script src="{{asset('public/assets/testimonial/testimonialv5/testimonialv5.js')}}"></script>
</body>
