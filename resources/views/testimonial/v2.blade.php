...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/testimonial/testimonialv2/testimonialv2.css') }}">
...
<body>
                ...
                <div id="testimonial-slider" class="owl-carousel">
                    <div class="testimonial">
                        ...
                        <div class="testimonial-content">
                            <div class="pic">
                                <img src="{{ asset('public/assets/testimonial/testimonialv2/img.jpg') }}">
                            </div>
    ...
    <script src="{{asset('public/assets/testimonial/testimonialv2/testimonialv2.js')}}"></script>
</body>
